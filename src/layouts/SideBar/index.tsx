    ...
    <div className={`sidebar-wrapper ${toggleSideBar ?"close_icon":""}`}>
      <div>
        <div className="logo-wrapper">
          ...
          <div className="back-btn" onClick={()=>dispatch(setToggleSideBar())}>
            <i className="fa fa-angle-left" />
          </div>
          <div className="toggle-sidebar" defaultChecked>
            <DynamicFeatherIcon iconName="Grid" className="status_toggle middle sidebar-toggle"/>
          </div>
        </div>
        <div className="logo-icon-wrapper">
          <Link href="/">
            <Image height={34} width={120} className="img-fluid" src={`${ImagePath}/logo/logo-icon.png`} alt=""/>
          </Link>
        </div>
